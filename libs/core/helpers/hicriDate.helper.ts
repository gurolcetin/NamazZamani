...
export const calculateRamadanCountBetweenDates = (
  startDate: Date,
  endDate: Date,
) => {
  const startHicriDate = convertMiladiDateToHicriDate(startDate, -1);
  const endHicriDate = convertMiladiDateToHicriDate(endDate, -1);
